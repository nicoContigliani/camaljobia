...
//           Genera un enlace único para compartir tu CV. Las personas con este enlace podrán ver y descargar tu CV, pero no podrán editarlo.
//         </Typography>
...
//     try {
//       // En una aplicación real, aquí harías una llamada a tu API para generar un token único
//       // y crear una ruta específica para compartir el CV
//       const cv = cvs.find(c => c._id === selectedCVId);
//       if (!cv) return;
      
//       // Simulamos la generación de un token (en producción, esto vendría del servidor)
//       const token = Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15);
      
//       // Construimos la URL para compartir (en producción, usarías tu dominio real)
//       const shareUrl = `${window.location.origin}/shared-cv/${selectedCVId}?token=${token}`;
      
//       setShareLink(shareUrl);
//       setSnackbar({ open: true, message: 'Enlace generado correctamente', severity: 'success' });
//     } catch (error) {
//       console.error('Error generating share link:', error);
//       setSnackbar({ open: true, message: 'Error al generar el enlace', severity: 'error' });
//     } finally {
...
// En tu CVPage.tsx existente, reemplaza la función handleGenerateShareLink con esto:
