...
// //           <SocialShare
// //             url={currentUrl}
// //             title={`CV  ${profile.fullname} | ${profile.professionalInfo?.title} | ${profile.email}`}
...
//       <Dialog open={shareModalOpen} onClose={handleCloseShareModal} maxWidth="md" fullWidth>
//         <DialogTitle>
...
//             Comparte este CV con otros mediante el siguiente enlace:
//           </Typography>
...
//           <Box sx={{ mt: 3 }}>
//             <Typography variant="body1" sx={{ mb: 2 }}>
//               O comparte directamente en redes sociales:
//             </Typography>
//             <SocialShare
//               url={currentUrl}
//               title={`CV ${profile.fullname} | ${profile.professionalInfo?.title} | ${profile.email}`}
...
//         </DialogContent>
//         <DialogActions>
//           <Button onClick={handleCloseShareModal}>Cerrar</Button>
//         </DialogActions>
//       </Dialog>
//     </Container>
//   );
...
export default function CVPage() {
  ...
  const handleGeneratePDF = async () => {
    if (!pdfRef.current || !cv || !profile) return;
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      {/* Contenedor principal con referencia para PDF */}
      <div ref={pdfRef}>
        {/* Header con acciones */}
        <Paper sx={{ p: 3, mb: 3, display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          <Box>
